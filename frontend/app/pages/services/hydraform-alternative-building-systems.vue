        ...
        <div class="container mt-5">
            <div class="row g-3 justify-content-center">
                ...
                <section class="col-lg-12">
                    ...
                    <ul>
                        <li>
                            <strong>Brick Production:</strong> On-site production of high-quality interlocking blocks
                            using locally sourced materials.
                        </li>
                        <li>
                            <strong>Interlocking Masonry:</strong> Expert construction using dry-stacking techniques for
                            speed and precision.
                        </li>
                        <li>
                            <strong>Sustainable Housing:</strong> Design and build of eco-estates and affordable housing
                            units.
                        </li>
                        <li>
                            <strong>Machine Rental & Sales:</strong> Provision of Hydraform machines and equipment for
